...
**YOU ARE IN: `systems_flake/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/systems_flake/` (rig root) or other directories
...
**Your mail address:** `systems_flake/polecats/furiosa`
**Your rig:** systems_flake
**Your Witness:** `systems_flake/witness`
...
| Ask Witness for help | `gt mail send systems_flake/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`systems_flake/witness`) when:
...
```bash
gt mail send systems_flake/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
