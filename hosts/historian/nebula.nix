# Nebula configuration for historian with agenix
{
  config,
  lib,
  pkgs,
  ...
  age.secrets = {
    ...
    nebula-cert = {
      file = ../../secrets/nebula-historian-cert.age;
      path = "/etc/nebula/historian.crt";
      owner = "nebula-mesh";
      group = "nebula-mesh";
      mode = "0644";
    };
    ...
    nebula-key = {
      file = ../../secrets/nebula-historian-key.age;
      path = "/etc/nebula/historian.key";
      owner = "nebula-mesh";
      group = "nebula-mesh";
      mode = "0600";
    };
