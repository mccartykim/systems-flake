...
in {
  services.homepage-dashboard = lib.mkIf cfg.services.homepage.enable {
    ...
    settings = let
      ...
      mkHomepageEntry = name: service: let
        ...
        serviceInfo = {
          ...
          copyparty = {
            title = "Copyparty";
            description = "File sharing and upload service";
          };
          homeassistant = {
        ...
        info =
          serviceInfo.${
            ...
            title = name;
            description = "Service on ${service.host}";
          };
      ...
      mkCategoryServices = category: serviceNames: let
        categoryServices =
          lib.filterAttrs (
            name: service:
