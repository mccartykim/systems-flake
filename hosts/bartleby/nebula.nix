# Nebula configuration for bartleby with agenix
...

{
  ...
  age.secrets = {
    ...
    nebula-cert = {
      file = ../../secrets/nebula-bartleby-cert.age;
      path = "/etc/nebula/bartleby.crt";
      owner = "nebula-mesh";
      group = "nebula-mesh";
      mode = "0644";
    };
    ...
    nebula-key = {
      file = ../../secrets/nebula-bartleby-key.age;
      path = "/etc/nebula/bartleby.key";
      owner = "nebula-mesh";
      group = "nebula-mesh";
      mode = "0600";
    };
