...
let
  ...
  userKeys = {
    ...
    # phone outbound (AVF Debian). The mochi GIT IDENTITY (registered on
    # GitHub, doubles as the VM's user key for ssh to fleet hosts). The old
    # droid@debian / mochi-root pairs died with the pre-rotation VM installs.
    mochi = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIEhGzxKkmPREx2xQUzKkM/mHoDwS2eWNKs8U1DdND8kQ mochi AVF git identity";
