...
# vacuum_organism repo.
{
  ...
  # The Chirurgeon's dispatch-servoskull wrapper (which used to file :WAKE
  # dispatches here as the vox-organism user) was REMOVED 2026-09-23 with
  # the bridge crew, so the vox-organism group grant is gone too.
}
