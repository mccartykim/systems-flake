# Nebula configuration for total-eclipse with agenix
{
  config,
  lib,
  pkgs,
...
in {
  ...
  age.secrets = {
    ...
    nebula-cert = {
      file = ../../secrets/nebula-total-eclipse-cert.age;
      path = "/etc/nebula/total-eclipse.crt";
      owner = "nebula-mesh";
      group = "nebula-mesh";
      mode = "0644";
    };
    ...
    nebula-key = {
      file = ../../secrets/nebula-total-eclipse-key.age;
      path = "/etc/nebula/total-eclipse.key";
      owner = "nebula-mesh";
      group = "nebula-mesh";
      mode = "0600";
    };
